...
- Run the GitHub Actions `Release` workflow from `main` when you want to apply version bumps, remove consumed changesets, publish packages, and push the generated commit and tags.
