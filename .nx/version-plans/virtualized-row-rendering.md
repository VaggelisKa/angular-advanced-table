...
The shared table engine now requires the row-render strategy registry wherever `NatTableState` is provided; both renderer shells (`NatTable` and `NatList`) provide it.
