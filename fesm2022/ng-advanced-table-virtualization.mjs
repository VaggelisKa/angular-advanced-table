...
class NatTableVirtualLayoutService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualLayoutService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualLayoutService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualLayoutService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class NatTableVirtualFocusService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualFocusService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualFocusService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualFocusService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class NatTableVirtualScrollEngine {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualScrollEngine, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualScrollEngine });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualScrollEngine, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class NatTableVirtualValidationService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualValidationService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualValidationService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualValidationService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class NatTableVirtualize {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualize, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.4", type: NatTableVirtualize, isStandalone: true, selector: "nat-table[natTableVirtualize]", inputs: { natTableVirtualize: { classPropertyName: "natTableVirtualize", publicName: "natTableVirtualize", isSignal: true, isRequired: true, transformFunction: null }, remoteRowCount: { classPropertyName: "remoteRowCount", publicName: "remoteRowCount", isSignal: true, isRequired: false, transformFunction: null }, rowWindowOffset: { classPropertyName: "rowWindowOffset", publicName: "rowWindowOffset", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { virtualRangeChange: "virtualRangeChange" }, host: { properties: { "style.--sys-nat-table-virtual-row-height.px": "rowHeight()" } }, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: NatTableVirtualize, decorators: [{
            type: Directive,
            args: [{
