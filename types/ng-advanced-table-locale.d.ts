 ...
 */
declare const NAT_NO_LOCALE_ID = "no";
/** Locale id for the built-in Swedish locale dictionaries. */
declare const NAT_SV_LOCALE_ID = "sv";
...
declare const NAT_DA_CONTROLS_LOCALE_LABELS: NatTableControlsIntl;
...
declare const NAT_DA_RENDER_METRICS_LOCALE_LABELS: NatTableRenderMetricsIntl;
 ...
 */
declare const matchNatTableLocaleId: (locales: Readonly<Record<string, unknown>> | undefined, localeId: string) => string | null;
