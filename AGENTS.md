...
- Showcase docs are prerendered from generated HTML: after changing `apps/showcase/public/docs/*.md`, run the showcase `generate-docs` target and commit the regenerated `apps/showcase/src/app/pages/docs/docs-html-registry.ts`. Do not hand-edit the generated registry; update Markdown/navigation/source examples instead, and keep routed examples represented in `app.route-paths.ts` when they are not discoverable from showcase navigation.
