  ...
  template: `
    <div class="showcase-page showcase-container">
      <header class="header-section">
        <h1 class="title">Sticky Header (Grid PoC)</h1>
        <p class="description">
          Proof of Concept demonstrating a sticky table header using CSS Grid and ARIA roles (Solution B).
          This pattern allows the header to stick to the browser viewport without container height restrictions (no <code>max-height</code> or <code>overflow-y</code> on the table container) while the body scrolls horizontally.
        </p>
      </header>

      <div class="grid-layout grid-layout-with-panel">
        <div class="card">
          <h2 class="card-title">Solution B Grid Table</h2>
        ...
        <div class="card">
          <h2 class="card-title">Technical Design</h2>
          <div class="control-panel">
            <h3>Key Features of Solution B:</h3>
            <ul class="features-list">
              <li><strong>No Wrapper Height Constraint:</strong> The table flows naturally on the page; the header sticks directly to the browser viewport as you scroll the main page.</li>
              <li><strong>Independent Horizontal Scroll:</strong> Wide columns scroll horizontally inside the body container.</li>
              <li><strong>Horizontal Sync:</strong> A scroll event listener on the body synchronizes the horizontal position to the header.</li>
              <li><strong>Full a11y Support:</strong> Screen readers see a single cohesive table tree because of the explicit ARIA roles (<code>role="table"</code>, etc.) wrapping the split header/body containers.</li>
            </ul>
            <div class="tip">
              Scroll down the page to see the header stick to the top of the browser viewport. Scroll horizontally on the table to see the synced horizontal alignment.
            </div>
          </div>
        </div>
      </div>
