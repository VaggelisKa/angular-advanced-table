...
import { StickyNoOverflowX } from './sticky-no-overflow-x';

describe('StickyNoOverflowX', () => {
  let fixture: ComponentFixture<StickyNoOverflowX>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [StickyNoOverflowX],
      providers: [provideZonelessChangeDetection()]
    }).compileComponents();

    fixture = TestBed.createComponent(StickyNoOverflowX);
