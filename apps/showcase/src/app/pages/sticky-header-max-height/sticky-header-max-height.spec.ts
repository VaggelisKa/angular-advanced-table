...
import { StickyHeaderMaxHeight } from './sticky-header-max-height';

describe('StickyHeaderMaxHeight', () => {
  let fixture: ComponentFixture<StickyHeaderMaxHeight>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [StickyHeaderMaxHeight],
      providers: [provideZonelessChangeDetection()]
    }).compileComponents();

    fixture = TestBed.createComponent(StickyHeaderMaxHeight);
