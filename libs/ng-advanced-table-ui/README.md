...
- Core table body cells clamp content to two lines by default; use `column.meta.cellHeight`, `column.meta.cellMaxLines`, or `column.meta.cellMaxLines = 'none'` on shared column definitions when companion UI columns need specific body-cell sizing.
