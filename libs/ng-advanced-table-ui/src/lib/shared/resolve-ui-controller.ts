import { assertInInjectionContext, computed, inject, isDevMode, type Signal } from '@angular/core';
import type { RowData } from '@tanstack/angular-table';

import { NatTableService } from './table.service';
import type { NatTableUiController } from './table-ui.types';

export interface InjectNatTableUiControllerOptions {
  /**
 ...
 */
export function injectNatTableUiController<TData extends RowData = RowData>(
