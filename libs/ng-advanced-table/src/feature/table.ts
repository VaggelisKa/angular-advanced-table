...
import { NatTableReorderService } from '../domain-logic/table-reorder.service';
import { NatTableResizeService } from '../domain-logic/table-resize.service';
...
import { isSpaceShortcutKey } from '../utils/keybindings';
import {
  canResizeColumn,
  getCellTone,
