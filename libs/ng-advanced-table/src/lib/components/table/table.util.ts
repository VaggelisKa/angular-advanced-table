...
type ColumnSortEntry = { desc: boolean };
...
export type ColumnRenderStateContext<TData extends RowData> = {
  ...
  primarySortColumnId: string | null;
  leftVisibleColumns: Column<TData, unknown>[];
  rightVisibleColumns: Column<TData, unknown>[];
  leftPinnedIds: ReadonlySet<string>;
  rightPinnedIds: ReadonlySet<string>;
 ...
 */
export const resolveColumnRenderWidth = <TData extends RowData>(
