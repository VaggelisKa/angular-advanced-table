import { CUSTOM_ELEMENTS_SCHEMA, Component, DestroyRef, Directive, inject, signal } from '@angular/core';

import { vi } from 'vitest';

import { NatTable, NatTableRowRenderStrategyRegistry, NatTableService } from 'ng-advanced-table';
