export { NAT_EN_UI_LOCALE_LABELS, NAT_TABLE_UI_ENGLISH_INTL, NAT_TABLE_UI_ENGLISH_LOCALE } from './ui-en';

export { NAT_TABLE_BUILT_IN_UI_LOCALES } from './ui-built-in-locales';
