...
import { NAT_DA_LOCALE_LABELS } from '../common/languages/da/accessibility.const';
import { NAT_DA_CONTROLS_LOCALE_LABELS } from '../common/languages/da/controls.const';
import { NAT_DA_RENDER_METRICS_LOCALE_LABELS } from '../common/languages/da/render-metrics.const';
import { NAT_FI_LOCALE_LABELS } from '../common/languages/fi/accessibility.const';
import { NAT_FI_CONTROLS_LOCALE_LABELS } from '../common/languages/fi/controls.const';
import { NAT_FI_RENDER_METRICS_LOCALE_LABELS } from '../common/languages/fi/render-metrics.const';
import { NAT_NB_LOCALE_LABELS } from '../common/languages/nb/accessibility.const';
import { NAT_NB_CONTROLS_LOCALE_LABELS } from '../common/languages/nb/controls.const';
import { NAT_NB_RENDER_METRICS_LOCALE_LABELS } from '../common/languages/nb/render-metrics.const';
import { NAT_SV_LOCALE_LABELS } from '../common/languages/sv/accessibility.const';
import { NAT_SV_CONTROLS_LOCALE_LABELS } from '../common/languages/sv/controls.const';
import { NAT_SV_RENDER_METRICS_LOCALE_LABELS } from '../common/languages/sv/render-metrics.const';
