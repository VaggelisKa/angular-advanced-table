...
import { NAT_TABLE_UI_ENGLISH_INTL, NAT_TABLE_UI_ENGLISH_LOCALE } from '../common/ui-en.const';
import type {
...
const mergeNatTableUiIntl = (parent: NatTableUiIntl | undefined, override: NatTableUiIntl): NatTableUiIntl => ({
...
/**
 * Registers every companion UI locale shipped by `ng-advanced-table/locale`.
 *
