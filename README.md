...
- Opt-in fixed-height row virtualization for large datasets (`ng-advanced-table/virtualization`)
...
│       ├── virtualization/   # Custom fixed-height row virtualization for NatTable
