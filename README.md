...
- `projects/ng-advanced-table`: the publishable core library.
- `projects/ng-advanced-table-utils`: optional companion helpers.
- `src/`: the showcase Angular application that consumes both libraries.
